...
public class Spring03Application {
	...
	public static void main(String[] args) {
		...
		phones.put("010-0000-7733", "IPhone 10");
		phones.put("010-9898-6089", "Galaxy S24");
		phones.put("010-6666-6690", "IPhone 11");

		System.out.println(phones);

		System.out.println(phones.get("010-6666-6690"));
		System.out.println(phones.values());
		System.out.println(phones.keySet());
		System.out.println(phones.containsKey("010-9898-6089"));
		System.out.println(phones.containsValue("Galaxy S11"));

		// 샘플 - 학생 네명의 국어, 영어, 수학, 미술, 체육, 점수를 합산하고 평균
